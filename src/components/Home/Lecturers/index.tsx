    ...
    return (
        <section id="Lecturer">
            <div className='container mx-auto lg:max-w-screen-xl md:max-w-screen-md px-4'>
                <Slider {...settings}>
                    {LecturerData.map((items, i) => (
                        <div key={i}>
                            <div className={`bg-white rounded-2xl m-4 p-5 my-20 relative ${i % 2 ? 'shadow-lecturer-shadow2' : 'shadow-lecturer-shadow1'}`}>
                                ...
                                <div className="flex justify-between items-center">
                                    <div>
                                        ...
                                        <h3 className='text-sm font-normal text-lightgray pb-2'>{items.nip}</h3>
                                    </div>
                                </div>
                                <h4 className='text-base font-normal text-darkgray my-4'>{items.kajian}</h4>
                            </div>
                        </div>
                    ))}
                </Slider>
