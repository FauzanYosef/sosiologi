                ...
                <div className="grid grid-cols-1 gap-y-10 gap-x-6 md:grid-cols-12 xl:gap-x-8">
                    <div className={`col-span-12 ${isProd ? 'bg-newsletter-bg-2' : 'bg-newsletter-bg'} bg-contain bg-no-repeat`}>
                        <div className="mb-10 mt-24 lg:mx-64 lg:my-24">
                            <h3 className="text-4xl md:text-5xl text-center font-semibold text-white mb-3">Layanan Departemen Sosiologi.</h3>
                            <h3 className="text-base font-normal text-white/75 text-center mb-8">
                            Memiliki pertanyaan terkait Departemen Sosiologi Fisip? 
                             <br /> Universitas Islam Negeri Sunan Gunung Djati Bandung? Hubungi Admin.
                            </h3>
                            <div>
